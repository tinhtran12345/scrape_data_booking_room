            ...
            const scraperDetail = async (link) =>
                new Promise(async (resolve, reject) => {
                    try {
                        ...
                        const mainContentDetail = await pageDetail.$$eval(
                        ...
                        // console.log(mainContentDetail);
                        // Cào lấy đặc điểm tin đăng
                        ...
                        // console.log(overviewContent);contact
                        // Cào lấy thông tin liên hệ
                        ...
                        console.log("Lấy data detail: " + error);
                        reject(error);
                    }
                });
